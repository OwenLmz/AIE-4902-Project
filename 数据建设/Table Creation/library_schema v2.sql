...
CREATE TABLE gate_log (
    ...
    capacity         SMALLINT    NOT NULL DEFAULT 2000    COMMENT '图书馆总容量（座位总数），前端展示为 total_in_library/capacity',
...
INSERT INTO gate_log (recorded_at, enter_count, exit_count, total_in_library, capacity, crowding_level, is_exam_week, day_of_week, hour_of_day) VALUES
('2025-06-16 08:00:00',  15,  2,   13, 2000, 'low',    0, 1, 8),
('2025-06-16 08:30:00',  42,  5,   50, 2000, 'low',    0, 1, 8),
('2025-06-16 09:00:00',  88, 12,  126, 2000, 'low',    0, 1, 9),
('2025-06-16 19:00:00', 210, 45,  680, 2000, 'high',   0, 1, 19),
('2025-06-16 20:00:00', 120, 90,  710, 2000, 'high',   0, 1, 20),
('2025-06-16 21:30:00',  30, 180, 412, 2000, 'medium', 0, 1, 21);
